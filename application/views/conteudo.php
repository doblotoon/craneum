                                ...
                                <ul class="media-list">
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <strong class="nomeUsuarioComentario">
                                                <?=$duvida['nome']?>
                                            </strong><p> em <?= date("d/m/Y", strtotime($duvida['dataDuvida']))?></p>
                                                <p>
                                                    <?=$duvida['duvida']?> 
                                                </p>
                                        </div>
<?php
            ...
            if (isset($_GET['rc'])) {
                ...
                if ( $_GET['rc']==1 and $_GET['idDuvida']==$duvida['idDuvida']) {
                    echo"<form action='../controllers/CadastrarResposta.php' method='post' class=''>
...
<?php
                ...
                if(isset($_SESSION['id'])){
                    ...
                    if ($_SESSION['tipo']=="professor" and $_SESSION['id']==$conteudoSelecionado['idUsuario']) {
